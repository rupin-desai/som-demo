...
export default function SecuritySection() {
  const platforms = [
    ...
    {
      name: "QuickBooks",
      logo: "https://iconape.com/wp-content/png_logo_vector/quickbooks.png",
    },
    {
      name: "Sage",
      logo: "https://vepimg.b8cdn.com/uploads/vjfnew//content/files/1654537986sage-logo-brilliant-green-rgb-png1654537986.png",
    },
    {
      name: "NetSuite",
    ...
    {
      name: "MYOB",
      logo: "https://mira.au/wp-content/uploads/2023/02/myob.png",
    },
    {
      name: "FreshBooks",
      logo: "https://images.seeklogo.com/logo-png/43/1/freshbooks-logo-png_seeklogo-431917.png",
    },
  ];
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(#e4b44b 1px, transparent 1px)",
      ...
      >
        ...
        <motion.div className="text-center mb-16" variants={fadeInUp}>
          <h2 className="text-4xl md:text-5xl font-bold text-secondary-navy mb-4">
            Securing Your{" "}
            <span className="text-accent-gold">Financial Future</span>
          </h2>
