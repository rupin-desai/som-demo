      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-secondary-navy">
              Your Name
            </label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <option value="Budget / Forecasting">Budget / Forecasting</option>
        ...
        <button
          ...
          className={`w-full font-bold py-4 rounded-[20px] transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform active:scale-95 ${
            status === "sending"
